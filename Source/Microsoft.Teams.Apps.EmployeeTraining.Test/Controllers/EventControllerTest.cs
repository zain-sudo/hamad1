...
namespace Microsoft.Teams.Apps.EmployeeTraining.Test.Controllers
{
    ...
    public class EventControllerTest
    {
        ...
        {
            this.userEventsHelper
                .Setup(u => u.RegisterToEventAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<TelemetryClient>()))
                .Returns(Task.FromResult(true));
        ...
        {
            this.userEventsHelper
                .Setup(u => u.UnregisterFromEventAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<TelemetryClient>()))
                .Returns(Task.FromResult(true));
