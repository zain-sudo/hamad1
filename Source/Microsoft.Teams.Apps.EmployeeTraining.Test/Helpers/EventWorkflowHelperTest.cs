    ...
    public class EventWorkflowHelperTest
    {
        ...
        public async Task UpdateEventAsync()
        {
            ...
            this.eventGraphHelper
                .Setup(x => x.UpdateEventAsync(It.IsAny<EventEntity>(), It.IsAny<TelemetryClient>()))
            ...
            var result = await this.eventWorkflowHelper.UpdateEventAsync(EventWorkflowHelperData.eventEntity, null);
            Assert.AreEqual(result, true);
        }
        ...
        public async Task UpdateEventStatus()
        {
            ...
            this.eventGraphHelper
                .Setup(x => x.CancelEventAsync(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<string>(), It.IsAny<TelemetryClient>()))
                .Returns(Task.FromResult(true));
            ...
            var result = await this.eventWorkflowHelper.UpdateEventStatusAsync(eventToCloseRegistration.TeamId, eventToCloseRegistration.EventId, (EventStatus)2, "8781d219-3920-4b4a-b280-48a17d2f23a6", null);
            Assert.AreEqual(result, true);
        }
        ...
        public async Task CreateNewEventAsync()
        {
            ...
            this.eventGraphHelper
                .Setup(x => x.CreateEventAsync(It.IsAny<EventEntity>(),null))
                .Returns(Task.FromResult(EventWorkflowHelperData.teamEvent));
            ...
            var result = await this.eventWorkflowHelper.CreateNewEventAsync(EventWorkflowHelperData.eventEntity, "",null);
