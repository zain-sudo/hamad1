...
namespace Microsoft.Teams.Apps.EmployeeTraining
{
    ...
    public static class ServicesExtension
    {
        ...
        public static void RegisterConfigurationSettings(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            {
                options.ServiceEmail = configuration.GetValue<string>("ServiceAccount:Username");
                options.ServicePassword = configuration.GetValue<string>("ServiceAccount:Password");
                options.EwsUrl = configuration.GetValue<string>("EwsServer");
            });
