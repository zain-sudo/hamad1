...
namespace Microsoft.Teams.Apps.EmployeeTraining.Helpers
{
    ...
    public interface IEventWorkflowHelper
    {
        ...
        /// <param name="telemetryClient">telemitry client</param>
        /// <returns>Boolean indicating save operation result.</returns>
        Task<bool?> CreateNewEventAsync(EventEntity eventEntity, string createdByName, TelemetryClient telemetryClient);
        ...
        /// <returns>Boolean indicating save operation result.</returns>
        Task<bool?> UpdateEventAsync(EventEntity eventEntity, TelemetryClient telemetryClient);
        ...
        Task<bool> UpdateEventStatusAsync(string teamId, string eventId, EventStatus eventStatus, string userAadId, TelemetryClient telemetryClient);
