...
namespace Microsoft.Teams.Apps.EmployeeTraining.Helpers
{
    ...
    public class UserEventsHelper : IUserEventsHelper
    {
        ...
        public async Task<bool> RegisterToEventAsync(string teamId, string eventId, string userAADObjectId, TelemetryClient telemetryClient)
        {
        ...
        public async Task<bool> UnregisterFromEventAsync(string teamId, string eventId, string userAADObjectId, TelemetryClient telemetryClient)
        {
            if (string.IsNullOrEmpty(teamId) || string.IsNullOrEmpty(eventId) || string.IsNullOrEmpty(userAADObjectId))
            {
                return false;
        ...
        private async Task<bool> UpdateGraphEvent(EventEntity eventToUpsert, TelemetryClient telemetryClient)
        {
