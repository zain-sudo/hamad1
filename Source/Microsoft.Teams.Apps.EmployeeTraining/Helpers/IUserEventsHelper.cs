...
namespace Microsoft.Teams.Apps.EmployeeTraining.Helpers
{
    ...
    public interface IUserEventsHelper
    {
        ...
        Task<bool> RegisterToEventAsync(string teamId, string eventId, string userAADObjectId, TelemetryClient telemetryClient);
        ...
        Task<bool> UnregisterFromEventAsync(string teamId, string eventId, string userAADObjectId, TelemetryClient telemetryClient);
    }
}